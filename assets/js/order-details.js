jQuery(document).ready(function ($) {
    ...
    $('.view-order-link').on('click', function (e) {
        ...
        $.getJSON(`/wp-json/orderflow-manager/v1/order/${orderId}`, function (data) {
            ...
            // Only show modal after content is loaded
