jQuery(document).ready(function ($) {
    ...
    $(document).on('click', '.generate-invoice-btn', function() {
        ...
        // Show loading state
        $modal.html('<div class="text-center">Generating invoice...</div>');
        ...
        $.getJSON(`/wp-json/orderflow-manager/v1/order/${orderId}`, function (data) {
            ...
            const invoiceHtml = `
                <div class="invoice-print-container fixed inset-0 bg-white">
                    ...
                    <div class="invoice-content-area max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto py-4 sm:py-10">
                        <div class="w-full mx-auto">
                            <div class="flex flex-col p-4 sm:p-10">
                                <div class="flex justify-between">
                                    <div>
                                        <h1 class="mt-2 text-lg md:text-xl font-semibold text-blue-600">Your Store Name</h1>
                                    </div>
                                    <div class="text-end">
                                ...
                                <div class="mt-8 ">
                                    <h4 class="text-lg font-semibold text-center text-gray-800">Thank you for your business!</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $('.print-invoice-btn').on('click', function() {
                const printStyles = `
                    <style type="text/css" media="print">
                        ...
                        /* Make only what needs to be printed visible */
                        .invoice-print-container,
                        .invoice-print-container * {
                            visibility: visible;
                        }

                        /* Force the container to take up the whole page */
                        .invoice-print-container {
                        ...
                        .invoice-content-area {
                            max-width: 190mm;
                            margin: 10mm auto !important; /* Top/bottom margin of 10mm, auto left/right */
                            padding: 0;
